      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="font-sans text-muted text-sm leading-relaxed">
            يمكنكِ ملء هذا النموذج لحجز موعد استشارة وتفصيل سريع، أو الانتقال
            مباشرة لمحادثتي على واتساب.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 bg-card border border-divider/20 p-8 rounded-2xl shadow-sm text-right">
            ...
            {isSubmitted ? (
              <div className="bg-rose-light/20 border border-rose-primary/30 p-8 rounded-xl text-center space-y-4">
                ...
                <h4 className="font-serif text-dark text-lg font-bold">
                  تم تسجيل طلبكِ
                </h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="name"
                    className="block text-xs font-sans font-bold tracking-wider text-dark/80"
                  >
                    الاسم الكريم *
                  </label>
                  <input
                ...
                <div className="space-y-2">
                  ...
                  >
                    <option value="تفصيل فستان سهرة">
                      تفصيل فستان سهرة مخصص
                    </option>
                    <option value="عباءة تقليدية مطرزة">
                      تفصيل عباءة مطرزة
                    </option>
                    <option value="ملابس أطفال للعيد">
                      تفصيل ملابس أطفال مخصصة
                    </option>
                    <option value="تعديل وتضييق فستان">
                      تعديل ملابس وفساتين عتيقة
                    </option>
                  </select>
                </div>
                ...
                >
                  <Send className="w-4.5 h-4.5 transform rotate-180" /> إرسال
                  عبر واتساب للتأكيد
                </button>
              </form>
            )}
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-8">
            ...
            <div className="bg-wine-dark text-white p-8 rounded-2xl border border-rose-primary/10 space-y-6 text-right flex-1 flex flex-col justify-center">
              ...
              <div className="space-y-6 font-sans font-light text-sm">
                <div className="flex items-start gap-3 justify-end">
                  <div className="text-right">
                    <span className="text-rose-light/60 block text-[10px] uppercase font-bold">
                      الموقع
                    </span>
                    <span className="text-white/95">
                      مشغل منزلي - الرياض، المملكة العربية السعودية
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 justify-end">
                  <div className="text-right">
                    <span className="text-rose-light/60 block text-[10px] uppercase font-bold">
                      مواعيد استقبال المقاسات
                    </span>
                    <span className="text-white/95">
                      يومياً من الساعة ٤ عصرًا حتى ٩ مساءً
                    </span>
                    <span className="block text-rose-light font-medium text-xs mt-1">
                      يرجى التنسيق المسبق عبر واتساب
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 justify-end">
                  <div className="text-right">
                    ...
                    <a
                      href="tel:+15550199821"
                      className="hover:text-rose-light transition-colors font-medium"
                    >
                      +966 55 019 9821
                    </a>
                  </div>
              ...
              <div className="pt-4 border-t border-rose-primary/20 flex items-center justify-between flex-row-reverse">
                ...
                >
                  <span className="text-base">📸</span> انستغرام المشغل
                </a>
              </div>
            </div>
            ...
            <div className="bg-white border border-divider/20 p-6 rounded-2xl text-center space-y-3">
              ...
              <p className="text-muted text-xs font-sans leading-relaxed">
                اضغطي على الزر بالأسفل لبدء دردشة مباشرة وسريعة لطرح أي استفسار
                بخصوص الأقمشة والأسعار.
              </p>
              <a
                href={whatsappUrl}
                target="_blank"
              ...
              >
                <MessageSquare className="w-4 h-4 fill-current" /> محادثة مباشرة
                على واتساب
              </a>
            </div>
          </div>
